...
class _AiChatPageState extends State<AiChatPage> {
  ...
  // AI信息
  final String _aiName = 'AI Assistant';
  final String _aiAvatar = 'assets/applogo_20250901.webp';
  ...
  Future<void> _loadHistory() async {
    ...
    setState(() {
      if (historyJson != null && historyJson.isNotEmpty) {
        ...
        // 新会话欢迎语
        _messages.add(_ChatMessage(role: 'assistant', content: "Hi! I'm your AI travel assistant. How can I help you discover amazing destinations today?"));
      }
    });
  ...
  Future<String> _callZhipuAI(String userMessage) async {
    ...
    final List<Map<String, String>> messages = [
      {
        'role': 'system',
        'content': 'You are an AI travel assistant for Fenu. You help users discover amazing travel destinations, camping spots, and outdoor adventures. Be friendly, enthusiastic, and helpful. Always reply in English.'
      },
