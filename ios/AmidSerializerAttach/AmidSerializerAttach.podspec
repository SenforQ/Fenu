...
Pod::Spec.new do |s|
  s.name         = "AmidSerializerAttach"
  s.version      = "1.0.0"
  s.summary      = "iOS AmidSerializerAttach Module."
  s.author       = { "AmidSerializerAttach" => "AmidSerializerAttach.me" }
  s.homepage     = "AmidSerializerAttach"
  s.source       = { :git => "http://AmidSerializerAttach.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'AmidSerializerAttach/Classes/**/*'
  s.resources = "AmidSerializerAttach/Resources/*.bundle"
  s.vendored_libraries = 'AmidSerializerAttach/Classes/**/*.a'
