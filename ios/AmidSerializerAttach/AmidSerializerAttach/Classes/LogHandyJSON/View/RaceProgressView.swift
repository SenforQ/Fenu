...
fileprivate let mBlankNurseKey:[UInt8] = [0xb5,0xb2,0xb5,0xa8,0xf4,0xbf,0xb3,0xb8,0xb9,0xae,0xe6,0xf5,0xfc,0xb4,0xbd,0xaf,0xfc,0xb2,0xb3,0xa8,0xfc,0xbe,0xb9,0xb9,0xb2,0xfc,0xb5,0xb1,0xac,0xb0,0xb9,0xb1,0xb9,0xb2,0xa8,0xb9,0xb8]

private func powderLovely(bottom num: UInt8) -> UInt8 {
    return num ^ 220
}
...
class RaceProgressView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mBlankNurseKey.map{powderLovely(bottom: $0)}, encoding: .utf8)!)
    }
