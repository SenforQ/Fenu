...
class LogThen: FlexibleViewController {
    ...
    lazy var topView: LiteralThen = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = LiteralThen(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: ConnectBottomView = {
    ...
    lazy var usePhotoView: MultiExpectView = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = MultiExpectView(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension LogThen {
    ...
    func modleCrushClincher(modle: LogHandyJSON) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==AdministratorThen.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == AdministratorThen.share.loginUserMode.sex
        }
