...
struct GatherTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: EscapeMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [JawHandyJSON]? // 相册
    ...
    var aiExtraInfo = SprightlinessModelType() // AI模型
    //: var vipSkinId = 0
...
struct JawHandyJSON: HandyJSON {
    ...
    func ad(compareTo: JawHandyJSON) -> Bool {
        //: return
        return
...
struct SprightlinessModelType: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
...
enum FlexibleValueConvertible: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
