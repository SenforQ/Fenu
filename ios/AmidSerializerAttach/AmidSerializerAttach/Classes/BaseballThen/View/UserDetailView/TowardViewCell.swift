...
fileprivate let appPlusMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Gifts received" :*/
fileprivate let appPopText:String = "Giftsexclusive round pro pen"
fileprivate let noti_pairValue:String = " recegive add sun progress base"
...
class TowardViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appPlusMessage.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(appPopText.prefix(5)) + String(noti_pairValue.prefix(5)) + "ived").localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(LiteralReusableView.self, forCellWithReuseIdentifier: LiteralReusableView.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension TowardViewCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: LiteralReusableView.className(), for: indexPath) as! LiteralReusableView
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: LogMeasurable = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.firstRole(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }
