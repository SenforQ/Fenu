...
fileprivate let mAvailableStr:[UInt8] = [0xae,0xa9,0xae,0xb3,0xef,0xa4,0xa8,0xa3,0xa2,0xb5,0xfd,0xee,0xe7,0xaf,0xa6,0xb4,0xe7,0xa9,0xa8,0xb3,0xe7,0xa5,0xa2,0xa2,0xa9,0xe7,0xae,0xaa,0xb7,0xab,0xa2,0xaa,0xa2,0xa9,0xb3,0xa2,0xa3]

/*: "Pending review" :*/
fileprivate let dream_travelTitle:[Character] = ["P","e","n","d","i","n","g"]
fileprivate let k_compareId:String = " reviewsensor new"
...
class EdgeView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mAvailableStr.map{$0^199}, encoding: .utf8)!)
    }
...
extension EdgeView {
    ...
    func satisfyOwn(model: RoundingRemovalModelType, row: Int, isLast: Bool) {
        //: index = row
        index = row
        //: islast = isLast
        islast = isLast
        ...
        if model.status == 0 {
            ...
            statusLb.text = (String(dream_travelTitle) + String(k_compareId.prefix(7))).localized
