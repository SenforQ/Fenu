...
class AdaptReactiveCompatible: NSObject {
    ...
    deinit {
        ...
        self.shouldOrBackingResource()
    }
}

// MARK: - Public Event
//: extension TalkingVideoInitivCallTool {
extension AdaptReactiveCompatible {
    /// 释放资源
    //: func shouldReleaseAllResource() {
    func shouldOrBackingResource() {
        //: destoryTRTCView()
        plusView()
    }
    ...
    func againCamera(_ frontCamera: Bool) {
        ...
        self.textFront(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func annunciation(_ openCamera: Bool) {
    ...
    func rail() {
        ...
        DispatchQueue.main.async {
            ...
            self.holderWithWindow(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension AdaptReactiveCompatible {
    ...
    private func textFront(front: Bool) {
    ...
    private func slice(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard user_progressId == true else {
            //: if isOpen {
            if isOpen {
...
extension AdaptReactiveCompatible {
    ...
    func delaySettings() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(presentAdjust(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(pastorNotif(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(networkNotif(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(developer(notif:)),
    ...
    @objc private func presentAdjust(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func pastorNotif(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func networkNotif(notif: Notification) {
    ...
    @objc func developer(notif: Notification) {
...
extension AdaptReactiveCompatible {
    ...
    func format() {
        ...
        if self.infoModel?.videoStage == .Waiting {
            ...
            holderWithWindow(smallWindow: false)
        ...
        //: } else if self.infoModel?.videoStage == .Calling {
            ...
            //: } else {
                ...
                holderWithWindow(smallWindow: true)
            }
        }
    ...
    func holderWithWindow(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard user_progressId == true else {
