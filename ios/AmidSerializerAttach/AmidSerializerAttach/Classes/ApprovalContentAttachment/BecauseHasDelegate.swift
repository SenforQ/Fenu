...
open class BecauseHasDelegate: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = BecauseHasDelegate.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
