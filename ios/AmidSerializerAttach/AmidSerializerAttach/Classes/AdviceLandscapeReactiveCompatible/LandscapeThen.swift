...
/*: "App" :*/
fileprivate let user_veryData:[Character] = ["A","p","p"]

/*: "blockList_ :*/
fileprivate let mShrinkFormat:String = "distant"
fileprivate let show_saleData:[Character] = ["l","o","c","k","L","i","s","t","_"]
...
class LandscapeThen: NSObject {
    ...
    func quickIn(userId: String) -> Bool {
    ...
    private func cachePath() -> String {
        ...
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(user_veryData)))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((mShrinkFormat.replacingOccurrences(of: "distant", with: "b") + String(show_saleData)) + "\(uid)")
        //: return filePath
        return filePath
    }
}
