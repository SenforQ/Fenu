...
let mBarStr = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let k_sendIdent = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let user_sessionMessage = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct DetectFairlyModelType: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
