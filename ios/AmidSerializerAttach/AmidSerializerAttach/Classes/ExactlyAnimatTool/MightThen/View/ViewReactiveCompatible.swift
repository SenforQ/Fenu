...
fileprivate let dreamPublisherTrailTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let appManagerPath:[Character] = ["i","c","o","n","_","l","i"]
fileprivate let noti_keepFormat:[Character] = ["v","e","t","c","_","w","a","r","n"]
...
class ViewReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dreamPublisherTrailTitle.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.scribeNumber(name: (String(appManagerPath) + String(noti_keepFormat)))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = AdministratorThen.share.appUserConfigMode.blockCameraPopupContent
        lab.text = AdministratorThen.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(humanRightCoatButtonSnap), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension ViewReactiveCompatible {
    ...
    @objc private func humanRightCoatButtonSnap() {
        //: dismiss()
        lateNightHour()
    }
}
