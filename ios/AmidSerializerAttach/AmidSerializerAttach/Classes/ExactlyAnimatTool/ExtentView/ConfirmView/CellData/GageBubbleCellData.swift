...
/*: ".png" :*/
fileprivate let mainSustainPath:String = ".pnginterrupt sweep feedback"
...
//: @objcMembers public class GageBubbleCellData: TalkingChatMsgBaseCellData {
@objcMembers public class GageBubbleCellData: MarkCellData {
    ...
    override public var msgModel: InformedConsentModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.vine(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func courseOfActionChatAuditoryImageGetVisualisation(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(dream_acceptFormat)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + AdministratorThen.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + AdministratorThen.share.loginUserMode.userID + (String(mainSustainPath.prefix(4)))
        ...
        let imageData = UIImage.handle(image, stillMore: 2 * 1024)
