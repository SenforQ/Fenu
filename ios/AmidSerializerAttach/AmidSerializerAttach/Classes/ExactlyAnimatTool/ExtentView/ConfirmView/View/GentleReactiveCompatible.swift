...
fileprivate let mProMsg:[UInt8] = [0x8a,0x8d,0x8a,0x97,0xcb,0x80,0x8c,0x87,0x86,0x91,0xd9,0xca,0xc3,0x8b,0x82,0x90,0xc3,0x8d,0x8c,0x97,0xc3,0x81,0x86,0x86,0x8d,0xc3,0x8a,0x8e,0x93,0x8f,0x86,0x8e,0x86,0x8d,0x97,0x86,0x87]

private func ballotText(approval num: UInt8) -> UInt8 {
    return num ^ 227
}
...
// __CLOSE_PRINT__
//
//  GentleReactiveCompatible.swift
//  AbroadTalking
//
...
class GentleReactiveCompatible: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func pure(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return GentleReactiveCompatible(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mProMsg.map{ballotText(approval: $0)}, encoding: .utf8)!)
    }
...
extension GentleReactiveCompatible {
