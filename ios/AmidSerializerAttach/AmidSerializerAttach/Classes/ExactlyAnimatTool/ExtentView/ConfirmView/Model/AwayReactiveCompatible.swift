...
@objcMembers class AwayReactiveCompatible: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: BecauseTransformable?
    //: var gift: TalkingMsgGiftModel?
    var gift: WarnGiftModel?
    //: var user: TalkingMsgUserModel?
    var user: TalkingHandyJSON?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: TalkingExpectPtolemaicSystemHandyJSON?
...
class BecauseTransformable: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class TalkingExpectPtolemaicSystemHandyJSON: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class WarnGiftModel: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
