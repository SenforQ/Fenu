...
@property (nonatomic, strong) EffectModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) WantModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) ThrowModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) AcceptableQuarterModel *wantGift; /// 想要礼物
...
@interface EffectModel : JSONModel
...
@interface ThrowModel: JSONModel
...
@interface ReleasingHormoneModel : JSONModel
...
@interface TalkingSProspectModel : JSONModel
...
@interface AcceptableQuarterModel : JSONModel
...
@interface PreferConversationModel : JSONModel
...
@property (nonatomic, strong) InvisibleModel *renderData;
...
@interface InvisibleModel : JSONModel
