...
@objc public enum PubliclyTransformable: UInt {
...
@objc public enum SignalTitleConvertible: UInt {
...
// MARK: - ReconstructThen

/**
 * 【模块名称】ReconstructThen
 ...
 */
//: @objcMembers public class ReconstructThen: TCommonCellData {
@objcMembers public class ReconstructThen: PoorThen {
    ...
    public var direction: SignalTitleConvertible = .MsgDirectionIncoming
    ...
    public var translateStatus: PubliclyTransformable = .MsgTranslate_init
    ...
    public var msgModel: InformedConsentModel = InformedConsentModel()
    ...
    public var cellLayout: TwoReactiveCompatible!
    ...
    public init(direction: SignalTitleConvertible) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.partnerPlan()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = TwoReactiveCompatible(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = TwoReactiveCompatible(isIncomming: false)
    ...
    public func sizeThinReading() -> CGSize {
        //: return CGSize.zero
        return CGSize.zero
    }
    ...
    public override func primaryThatWidth(_ width: CGFloat) -> CGFloat {
