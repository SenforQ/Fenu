...
@objcMembers public class PoorThen: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func primaryThatWidth(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class TakeViewCell: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: PoorThen?
    ...
    @objc dynamic public func fieldWith(with data: PoorThen) {
        //: self.data = data
        self.data = data
    }
} 
