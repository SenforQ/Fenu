 ...
 *
 *  StudyHypothesisDelegate 协议和 MessageViewController 类。
 *  MessageViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 MessageViewController 的具体声明。
 *
 ******************************************************************************/
...
//: @class AutoloadingReactiveCompatible;
@class AutoloadingReactiveCompatible;
//: @class ReconstructThen;
@class ReconstructThen;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
@protocol StudyHypothesisDelegate <NSObject>
...
- (void)localing:(MessageViewController *)controller;
...
- (void)availables:(MessageViewController *)controller;
...
- (BOOL)activityEnable:(MessageViewController *)controller process:(UIView *)view;
 ...
 */
//: - (ReconstructThen *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (ReconstructThen *)change:(MessageViewController *)controller counterest:(V2TIMMessage *)data;
 ...
 */
//: - (AutoloadingReactiveCompatible *)messageController:(TUIMessageController *)controller onShowMessageData:(ReconstructThen *)data;
- (AutoloadingReactiveCompatible *)message:(MessageViewController *)controller observer:(ReconstructThen *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(AutoloadingReactiveCompatible *)cell;
- (void)image:(MessageViewController *)controller up:(AutoloadingReactiveCompatible *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(AutoloadingReactiveCompatible *)cell;
- (void)orientationOrigin:(MessageViewController *)controller makeup:(AutoloadingReactiveCompatible *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(ReconstructThen *)data;
- (void)message:(MessageViewController *)controller streetSmart:(NSInteger)menuType full:(ReconstructThen *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(AutoloadingReactiveCompatible *)cell;
- (void)identity:(MessageViewController *)controller loadController:(AutoloadingReactiveCompatible *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(ReconstructThen *)cellData;
- (void)gesture:(MessageViewController *)controller device:(ReconstructThen *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(ReconstructThen *)cellData;
- (void)gift:(MessageViewController *)controller click:(ReconstructThen *)cellData;
...
/**
 *  执行 StudyHypothesisDelegate 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<StudyHypothesisDelegate> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<ReconstructThen *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成ReconstructThen
 */
