...
@objcMembers public class TwoReactiveCompatible: NSObject {
    ...
    class func accelerate() -> TwoReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = TwoReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func mapOut() -> TwoReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = TwoReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func throughOwner() -> TwoReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = TwoReactiveCompatible.init(isIncomming: false)
    ...
    class func ballBreaker() -> TwoReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = TwoReactiveCompatible.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func cypherLayout() -> TwoReactiveCompatible {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = TwoReactiveCompatible.init(isIncomming: false)
        //: return layout
        return layout
