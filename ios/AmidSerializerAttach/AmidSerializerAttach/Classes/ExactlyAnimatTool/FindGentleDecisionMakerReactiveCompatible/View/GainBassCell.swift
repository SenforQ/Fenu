...
fileprivate let showVisibleValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class GainBassCell: CantBassCell {
    //: override var msgModel: TalkingLiveRoomDanmuModel {
    override var msgModel: AccountMeasurable {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showVisibleValue.reversed(), encoding: .utf8)!)
    }
}

//: extension TalkingDanmuMsgTextCell {
extension GainBassCell {
    //: func setCell() {
    func customerDown() {
