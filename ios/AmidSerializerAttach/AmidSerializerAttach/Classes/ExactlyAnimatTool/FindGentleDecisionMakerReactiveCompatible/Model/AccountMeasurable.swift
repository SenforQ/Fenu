...
let userHalfMsg = actualWidth(w: 275)
//: let MsgTableViewHeight =  actualWidth(w: 200)
let user_intervalMsg = actualWidth(w: 200)
//: let cellLineSpeing = 3
let userAskMessage = 3 /// cell间距

//: struct TalkingLiveRoomDanmuModel: HandyJSON {
struct AccountMeasurable: HandyJSON {
    //: var msgInfo: TalkingDanmuMsgInfo?
    var msgInfo: WaitPubMsgInfo?
    //: var user: TalkingDanmuUserInfo?
    var user: ProcedureHandyJSON?
    //: var gift: TalkingGiftMsgAnimatModel?
    var gift: RaceMeasurable?
    //: var toUser: TalkingDanmuUserInfo?
    var toUser: ProcedureHandyJSON?
...
struct WaitPubMsgInfo: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var messageType = 0
...
struct ProcedureHandyJSON: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var nickname = ""
    var nickname = ""
