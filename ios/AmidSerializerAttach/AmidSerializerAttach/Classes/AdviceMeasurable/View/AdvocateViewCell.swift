...
fileprivate let userWipeUponName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_home_boy" :*/
fileprivate let m_makeupStr:String = "lap"
fileprivate let k_warmPath:[Character] = ["c","o","n","_","h","o","m","e","_","b","o","y"]

/*: "icon_home_girl" :*/
fileprivate let dream_involveStr:[Character] = ["i","c","o","n","_","h"]
fileprivate let dreamAliveText:[Character] = ["o","m","e","_","g","i","r","l"]
...
class AdvocateViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userWipeUponName.reversed(), encoding: .utf8)!)
    }
...
extension AdvocateViewCell {
    //: func setOnlineListCell(model: TalkingChatRoomMemberModel, type: TitleType) {
    func pocketSized(model: LanceTransformable, type: HeapContiguousBytes) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.scribeNumber(name: (m_makeupStr.replacingOccurrences(of: "lap", with: "i") + String(k_warmPath))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.scribeNumber(name: (String(dream_involveStr) + String(dreamAliveText))), for: .normal)
        //: break
        //: default:
        default:
            //: break
