...
/*: "#777777" :*/
fileprivate let appArcBudgetWordPath:[Character] = ["#","7","7","7","7"]
fileprivate let showGatherId:String = "flatflat"

/*: "#333333" :*/
fileprivate let appImpressionTitle:String = "#whatwhat3"
fileprivate let main_conditionId:String = "option"

/*: "Followers" :*/
fileprivate let mAwakeUrl:String = "Followersicon input ticket warning speed"

/*: "Following" :*/
fileprivate let show_valueName:String = "Followfatal automatically minimum admin witch"
fileprivate let mainMirrorIdent:[Character] = ["i","n","g"]

/*: "nav_back_black_nor" :*/
fileprivate let appWaveUrl:[Character] = ["n","a","v","_","b","a","c","k","_","b","l","a"]
fileprivate let notiSweepAllianceKey:String = "ck_norballoon mind library minor stretch"
...
class VisitorViewDelegate: FlexibleViewController {
    //: var currentIndex = 0
    var currentIndex = 0
...
//        segmentedDataSource.itemSpacing = 0
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (String(appArcBudgetWordPath) + showGatherId.replacingOccurrences(of: "flat", with: "7")))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (appImpressionTitle.replacingOccurrences(of: "what", with: "33") + main_conditionId.replacingOccurrences(of: "option", with: "3")))!
        ...
        indicator.indicatorColor = UIColor(hex: (appImpressionTitle.replacingOccurrences(of: "what", with: "33") + main_conditionId.replacingOccurrences(of: "option", with: "3")))!
    ...
    private lazy var titleArray: [String] = //: return ["Followers".localized, "Following".localized]
        [(String(mAwakeUrl.prefix(9))).localized, (String(show_valueName.prefix(6)) + String(mainMirrorIdent)).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [FlexibleViewController] = //: return [CandidateViewDelegate(), FindViewDelegate()]
        [CandidateViewDelegate(), FindViewDelegate()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.scribeNumber(name: (String(appWaveUrl) + String(notiSweepAllianceKey.prefix(6)))).withRenderingMode(.alwaysTemplate)
...
extension VisitorViewDelegate: JXSegmentedViewDelegate {
...
extension VisitorViewDelegate: JXPagingViewDelegate {
