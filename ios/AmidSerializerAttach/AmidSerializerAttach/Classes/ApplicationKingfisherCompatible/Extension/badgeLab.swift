...
class SignalView: UILabel {
    ...
    //: private func setup() {
    private func spendSetup() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.nonsolidColor().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.afterDisable(type: .Medium, fontSize: 11)
...
class InjuryMarkReactiveCompatible: UILabel {
