...
@objcMembers public class FilterModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = BeautyValueConvertible.Face
...
@objc extension FilterModel {
    //: func initWith(suiteType: BeautyItemType)-> STFilterEntiretycostModel {
    func flat(suiteType: BeautyValueConvertible) -> FilterModel {
