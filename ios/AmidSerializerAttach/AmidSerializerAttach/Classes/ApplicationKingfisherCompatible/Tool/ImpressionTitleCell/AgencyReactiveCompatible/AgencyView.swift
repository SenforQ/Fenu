...
/*: "st_slider_thumb" :*/
fileprivate let m_suiteFlagPath:[Character] = ["s","t","_","s","l","i","d","e","r","_","t"]
fileprivate let main_resFormat:String = "humissing"

/*: "init(coder:) has not been implemented" :*/
fileprivate let showOptionText:[UInt8] = [0xc5,0xc2,0xc5,0xd8,0x84,0xcf,0xc3,0xc8,0xc9,0xde,0x96,0x85,0x8c,0xc4,0xcd,0xdf,0x8c,0xc2,0xc3,0xd8,0x8c,0xce,0xc9,0xc9,0xc2,0x8c,0xc5,0xc1,0xdc,0xc0,0xc9,0xc1,0xc9,0xc2,0xd8,0xc9,0xc8]

private func mirrorFavorite(yellow num: UInt8) -> UInt8 {
    return num ^ 172
}
...
class AgencyView: UISlider {
    ...
    override var currentThumbImage: UIImage? {
        ...
        get {
            ...
            return UIImage.scribeNumber(name: (String(m_suiteFlagPath) + main_resFormat.replacingOccurrences(of: "missing", with: "mb")))
        }
        //: set {
        set {}
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showOptionText.map{mirrorFavorite(yellow: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var valueView: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.afterDisable(type: .Regular, fontSize: 12)
...
extension AgencyView {
    ...
    func becomeFragment(value: Float) {
