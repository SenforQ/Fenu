...
class InstanceNameView: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        roundSetup(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        roundSetup(placeholder: nil, placeholderColor: nil)
    }
}
...
extension InstanceNameView {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func roundSetup(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(DenominateLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(DenominateLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-DenominateLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: MovieContainerInset().top, left: MovieContainerInset().left, bottom: MovieContainerInset().bottom, right: MovieContainerInset().right)
...
extension InstanceNameView: UITextViewDelegate {
...
extension InstanceNameView {
    ...
    private func creatingByRemoval() {
