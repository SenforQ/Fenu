...
fileprivate let main_modelMsg:[Character] = ["b","t","n","_","m","e","_"]
fileprivate let mAnotherValue:String = "BACK"
fileprivate let main_aspectTitle:String = "inupsychological"

/*: "init(coder:) has not been implemented" :*/
fileprivate let user_jumpShapeFormat:[UInt8] = [0xc,0xb,0xc,0x11,0x4d,0x6,0xa,0x1,0x0,0x17,0x5f,0x4c,0x45,0xd,0x4,0x16,0x45,0xb,0xa,0x11,0x45,0x7,0x0,0x0,0xb,0x45,0xc,0x8,0x15,0x9,0x0,0x8,0x0,0xb,0x11,0x0,0x1]
...
class WarnAlertView: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(rewardNear), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(rightOfAction), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: GainGageAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(main_modelMsg) + mAnotherValue.lowercased() + "_cont" + main_aspectTitle.replacingOccurrences(of: "psychological", with: "e"))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_jumpShapeFormat.map{$0^101}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func alongGold(title: String, isTouch: Bool) {
