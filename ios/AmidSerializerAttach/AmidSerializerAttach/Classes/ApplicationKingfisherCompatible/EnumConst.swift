...
enum ExactlyNameConvertible: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum EditionTableConvertible: String {
    //: case AppleLogin
...
enum AutomaticMeasurable: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum MovieBecauseTitleConvertible: Int {
    //: case isOnGoing = 0
...
@objc enum BecauseMultiplierTarget: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum CantSignedCount: Int {
    //: case Unavailable = 0
...
enum CreateCellType: CaseIterable {
